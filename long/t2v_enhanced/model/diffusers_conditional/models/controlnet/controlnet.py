...
class ControlNetModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        if use_reference_attention:
            print("has reference attention")
            self.reference_conv_in = Conv2D_SubChannels(
                in_channels, block_out_channels[0], kernel_size=conv_in_kernel, padding=conv_in_padding
            )
    ...
    def forward(
        ...
        # print("Reference frames features shape going to attention = ", reference_frames_features.shape)
        ...
        # print(f"Sample shape before conv_in = {sample.shape}")
        ...
        for downsample_block in self.down_blocks:
            # print(f"Sample shape before downsample_block = {sample.shape}")
